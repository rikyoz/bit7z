...
TEST_CASE( "BitItemsVector: Indexing a valid directory", "[bititemsvector]" ) {
    ...
    const auto test_directory = GENERATE(
        ...
        TestDirectory{
            ...
            {
                "subfolder2",
                "subfolder2/homeworks.doc",
                "subfolder2/The quick brown fox.pdf",
                "subfolder2/trends.xlsx"
            }
        }
    );
...
TEST_CASE( "BitItemsVector: Indexing a valid directory (filtered)", "[bititemsvector]" ) {
    ...
    SECTION( "Wildcard filter *.folder (only files)" ) {
        ...
        REQUIRE_NOTHROW( items_vector.indexDirectory( ".", BIT7Z_STRING( "*.folder" ), options ) );
        REQUIRE( items_vector.size() == 0 );
    }
    ...
    SECTION( "Only DOC files" ) {
        const auto test_directory = GENERATE(
            TestDirectory{ ".", { "folder/subfolder2/homeworks.doc" } },
            TestDirectory{ "empty", {} },
            TestDirectory{ "./empty", {} },
            TestDirectory{ "folder", { "folder/subfolder2/homeworks.doc" } },
            TestDirectory{ "./folder", { "subfolder2/homeworks.doc" } },
            TestDirectory{ "folder/subfolder2", { "folder/subfolder2/homeworks.doc" } },
            TestDirectory{ "./folder/subfolder2", { "homeworks.doc" } }
        );
    ...
    SECTION( "Only XLSX files" ) {
        const auto test_directory = GENERATE(
            TestDirectory{ ".", { "folder/subfolder2/trends.xlsx" } },
            TestDirectory{ "empty", {} },
            TestDirectory{ "./empty", {} },
            TestDirectory{ "folder", { "folder/subfolder2/trends.xlsx" } },
            TestDirectory{ "./folder", { "subfolder2/trends.xlsx" } },
            TestDirectory{ "folder/subfolder2", { "folder/subfolder2/trends.xlsx" } },
            TestDirectory{ "./folder/subfolder2", { "trends.xlsx" } }
        );
...
TEST_CASE( "BitItemsVector: Indexing a valid directory (non-recursively, filtered)", "[bititemsvector]" ) {
    ...
    SECTION( "Wildcard filter *.* (only files)" ) {
        ...
        const auto test_directory = GENERATE(
            TestDirectory{ ".", { "italy.svg", "Lorem Ipsum.pdf" } },
            TestDirectory{ "empty", {} },
            TestDirectory{ "./empty", {} },
            TestDirectory{ "folder", { "folder/clouds.jpg" } },
            TestDirectory{ "./folder", { "clouds.jpg" } },
            ...
            TestDirectory{ "./folder/subfolder2", { "homeworks.doc", "The quick brown fox.pdf", "trends.xlsx" } }
        );
    ...
    SECTION( "Only PDF files" ) {
        ...
        DYNAMIC_SECTION ( "Indexing directory " << test_directory.path ) {
            REQUIRE_NOTHROW( items_vector.indexDirectory( test_directory.path, BIT7Z_STRING( "*.pdf" ), options ) );
    ...
    SECTION( "Only SVG files" ) {
        ...
        DYNAMIC_SECTION ( "Indexing directory " << test_directory.path ) {
            REQUIRE_NOTHROW( items_vector.indexDirectory( test_directory.path, BIT7Z_STRING( "*.svg" ), options ) );
    ...
    SECTION( "Only JPG files" ) {
        ...
        DYNAMIC_SECTION ( "Indexing directory " << test_directory.path ) {
            REQUIRE_NOTHROW( items_vector.indexDirectory( test_directory.path, BIT7Z_STRING( "*.jpg" ), options ) );
    ...
    SECTION( "Only DOC files" ) {
        ...
        DYNAMIC_SECTION ( "Indexing directory " << test_directory.path ) {
            REQUIRE_NOTHROW( items_vector.indexDirectory( test_directory.path, BIT7Z_STRING( "*.doc" ), options ) );
    ...
    SECTION( "Only XLSX files" ) {
        ...
        DYNAMIC_SECTION ( "Indexing directory " << test_directory.path ) {
            REQUIRE_NOTHROW( items_vector.indexDirectory( test_directory.path, BIT7Z_STRING( "*.xlsx" ), options ) );
    ...
    SECTION( "Only PNG files (no matching file)" ) {
        ...
        DYNAMIC_SECTION ( "Indexing directory " << test_directory ) {
            REQUIRE_NOTHROW( items_vector.indexDirectory( test_directory, BIT7Z_STRING( "*.png" ), options ) );
            REQUIRE( items_vector.size() == 0 );
        }
    }
    ...
    const auto test_directory = GENERATE(
        TestDirectory{
            "../test_filesystem",
            {
                ...
                "test_filesystem/folder/subfolder2",
                "test_filesystem/folder/subfolder2/homeworks.doc",
                "test_filesystem/folder/subfolder2/The quick brown fox.pdf",
                "test_filesystem/folder/subfolder2/trends.xlsx"
            }
        },
    ...
    const auto test_directory = GENERATE(
        TestDirectory{
            ".",
            {
                ...
                "custom_folder/folder/subfolder2/homeworks.doc",
                "custom_folder/folder/subfolder2/The quick brown fox.pdf",
                "custom_folder/folder/subfolder2/trends.xlsx"
            }
        },
        ...
        TestDirectory{
            "folder",
            {
                ...
                "custom_folder/subfolder2/homeworks.doc",
                "custom_folder/subfolder2/The quick brown fox.pdf",
                "custom_folder/subfolder2/trends.xlsx"
            }
        },
        TestDirectory{
            "./folder",
        ...
        TestDirectory{
            ...
            {
                "custom_folder",
                "custom_folder/homeworks.doc",
                "custom_folder/The quick brown fox.pdf",
                "custom_folder/trends.xlsx"
            }
        },
        TestDirectory{
            "./folder/subfolder2",
