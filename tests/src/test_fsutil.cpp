...
TEST_CASE( "fsutil: Getting file extension from a path string", "[fsutil][file extension]" ) {
    auto test_path_string = GENERATE( as< tstring >(),
                                      BIT7Z_STRING( "" ),
                                      BIT7Z_STRING( "." ),
                                      BIT7Z_STRING( "foo" ),
                                      BIT7Z_STRING( "foo.cpp" ),
                                      BIT7Z_STRING( "foo.tar.gz" ),
                                      BIT7Z_STRING( "foo/bar.cpp" ),
                                      BIT7Z_STRING( "foo\\bar.cpp" ),
                                      BIT7Z_STRING( "foo/bar.tar.gz" ),
                                      BIT7Z_STRING( "foo\\bar.tar.gz" ),
                                      BIT7Z_STRING( "hello.world/foo.cpp" ),
                                      BIT7Z_STRING( "hello.world\\foo.cpp" ),
                                      BIT7Z_STRING( "hello.world/foo.tar.gz" ),
                                      BIT7Z_STRING( "hello.world\\foo.tar.gz" ),
                                      BIT7Z_STRING( "../" ),
                                      BIT7Z_STRING( "..\\" ),
                                      BIT7Z_STRING( "../foo" ),
                                      ...
                                      BIT7Z_STRING( "C:/foo" ),
                                      BIT7Z_STRING( "C:\\foo" ),
                                      BIT7Z_STRING( "C:/foo.cpp" ),
                                      BIT7Z_STRING( "C:\\foo.cpp" ),
                                      BIT7Z_STRING( "C:/foo.tar.gz" ),
                                      BIT7Z_STRING( "C:\\foo.tar.gz" ),
                                      BIT7Z_STRING( "C:/foo/bar" ),
                                      BIT7Z_STRING( "C:\\foo\\bar" ),
                                      BIT7Z_STRING( "C:/foo/bar.cpp" ),
                                      BIT7Z_STRING( "C:\\foo\\bar.cpp" ),
                                      BIT7Z_STRING( "C:/foo/bar.tar.gz" ),
                                      BIT7Z_STRING( "C:\\foo\\bar.tar.gz" ),
                                      BIT7Z_STRING( "C:/hello.world/foo.cpp" ),
                                      BIT7Z_STRING( "C:\\hello.world\\foo.cpp" ),
                                      BIT7Z_STRING( "C:/hello.world/foo.tar.gz" ),
                                      BIT7Z_STRING( "C:\\hello.world\\foo.tar.gz" ),
                                      BIT7Z_STRING( "C:/foo/../bar" ),
                                      BIT7Z_STRING( "C:\\foo\\..\\bar" ),
                                      BIT7Z_STRING( "C:/foo/../bar.cpp" ),
    ...
    fs::path test_path{ test_path_string };
    SECTION( "Test path: '" + test_path.string() + "'" ) {
        auto test_extension = test_path.extension();
        if ( !test_extension.empty() ) {
            // bit7z's extension function always returns the extension _without_ the dot character,
            // while the C++ standard's extension function always return the extension _with_ the dot character.
            REQUIRE( BIT7Z_STRING( "." ) + extension( test_path_string ) == test_extension );
        } else {
            // If the file doesn't have an extension, also bit7z's extension function returns an empty string.
            REQUIRE( extension( test_path_string ).empty() );
        }
    }
}
