...
static constexpr std::array< uint16_t, 256 > crc16_table = { // CRC-16/LHA standard
...
template< std::size_t Bits >
using crc_table = std::array< uint_t< Bits >, 256 >;

template< std::size_t Bits,
          uint_t< Bits > initial,
          uint_t< Bits > mask,
          typename = typename std::enable_if< is_power_of_two( Bits ) >::type >
inline auto crc( crc_table< Bits > table, const void* buffer, std::size_t length ) noexcept -> uint_t< Bits > {
