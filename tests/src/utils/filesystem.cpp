...
const FilesystemItemInfo loremIpsum{
...
const FilesystemItemInfo noext{
    BIT7Z_STRING( "noext" ),
    BIT7Z_STRING( "" ),
    fs::file_type::regular,
    34,
...
const FilesystemItemInfo greek{
...
const FilesystemItemInfo dotFolder{
...
const FilesystemItemInfo helloJson{
    BIT7Z_STRING( "hello.json" ),
    BIT7Z_STRING( "json" ),
    fs::file_type::regular,
    29,
    0x794FDB10,
...
const FilesystemItemInfo emptyFolder{
    BIT7Z_STRING( "empty" ),
    BIT7Z_STRING( "" ),
    fs::file_type::directory,
    0,
...
const FilesystemItemInfo folder{
    BIT7Z_STRING( "folder" ),
    BIT7Z_STRING( "" ),
    fs::file_type::directory,
    0,
...
const FilesystemItemInfo subfolder{
    BIT7Z_STRING( "subfolder" ),
    BIT7Z_STRING( "" ),
    fs::file_type::directory,
    0,
    0,
...
const FilesystemItemInfo subfolder2{
    BIT7Z_STRING( "subfolder2" ),
    BIT7Z_STRING( "" ),
    fs::file_type::directory,
    0,
    0,
...
const FilesystemItemInfo homework{
    BIT7Z_STRING( "homework.doc" ),
    BIT7Z_STRING( "doc" ),
    fs::file_type::regular,
    31232,
    0x1734526A,
...
const FilesystemItemInfo quickBrown{
    BIT7Z_STRING( "The quick brown fox.pdf" ),
    BIT7Z_STRING( "pdf" ),
    fs::file_type::regular,
    45933,
    0x3A4DCE2A,
...
const FilesystemItemInfo frequency{
    BIT7Z_STRING( "frequency.xlsx" ),
    BIT7Z_STRING( "xlsx" ),
    fs::file_type::regular,
    20803,
    0xA140E471,
...
const FilesystemItemInfo clouds{
...
const FilesystemItemInfo hidden{
    BIT7Z_STRING( "hidden" ),
    BIT7Z_STRING( "" ),
    fs::file_type::regular,
    6,
...
const FilesystemItemInfo readOnly{
    BIT7Z_STRING( "read_only" ),
    BIT7Z_STRING( "" ),
    fs::file_type::regular,
    9,
    0x1EAF9877,
...
const FilesystemItemInfo regular{
    BIT7Z_STRING( "regular" ),
    BIT7Z_STRING( "" ),
    fs::file_type::regular,
    13,
    0x01D7AFB4,
...
const FilesystemItemInfo symlink{
    BIT7Z_STRING( "symlink" ),
    BIT7Z_STRING( "" ),
#ifdef _WIN32
    fs::file_type::regular,
#else
...
const FilesystemItemInfo surrogatePairs{
    BIT7Z_STRING( "𤭢.txt" ),
    BIT7Z_STRING( "txt" ),
    fs::file_type::regular,
    23,
